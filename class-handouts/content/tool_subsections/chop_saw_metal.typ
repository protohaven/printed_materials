...
// Questions
//
// Is the blade a user-serviceable part on this machine? No.
...
This tool is best for shallow cutting angles. 

The metal chop saw can be very dangerous: be very careful using this tool. 
...
Be mindful of the area to the right of the metal chop saw; waste pieces may go in that direction after a cut is complete. Be extra careful if another shop member is using the metal drill press or grinders.

Do not use the metal chop saw to cut small pieces. If the cut will cause your fingers to be within 150mm of the saw blade, the workpiece is too small.
...
We have a 14” blade, but the signage on the saw lists capacities for a 15” blade. Be conservative.

Apply gentle pressure during a cut. The idea is to take light chips or shavings with the cutting heads, not grind through the workpiece. Applying excess pressure will not make the machine perform any better, and may reduce the lifetime of the motor and the blade.
...
Lift the blue handle to slide the front vice jaw away form or into the workpiece. Always replace the quick release mechanism before using the saw to make sure proper camping force is being applied to the workpiece.

=== Front Swiveling Vice Jaw

The front vise jaw can swivel to accommodate workpieces held at an angle.
...
The rear vise jaw can be locked into position to accommodate workpieces held at an angle.
...
Use the protractor scale to align the rear vice jaw to an angle. 
...
The chip collection tray catches chips and dust that are ejects downward out of the cut. 

Check the chip collection tray for any material that extends into the cutting area, and might interfere with a cut. Clear out any interfering material before making a cut.
...
- Make sure the workpiece is is full contact with the table. \
  _If the piece drops during the cut, it could rack and move into the blade._
- Make sure the front clamp is tight.
- Make sure the back clamp is set and clamped.

Check that *both* ends of the workpiece are secure in the vise (not just the end near the blade).
