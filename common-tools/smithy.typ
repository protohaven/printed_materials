...
Something something make ourselves better smiths.
...
+ Heat your material by placing it in the lit forge on the firebrick.
+ Let the material soak until the area you want to forge is glowing yellow.
+ Use tongs to transfer the material to the anvil or leg vise for working.
+ Work the material as needed.
...
When you pull material out of the water, note how quickly it dries. If the material dries immediately, it is still too hot to handle with bare hands. If the material stays wet, it _might_ be safe to touch: proceed with caution.

=== Cleaning Up

+ Close the tank isolation valve.
+ Close the forge isolation valve.
